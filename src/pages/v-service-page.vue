      ...
      services: [
        {
          ...
          desc: 'Стоматолог-ортопед занимается восстановлением зубов и зубных рядов с помощью различных видов протезирования, включая съемные и несъемные протезы.',
          src: 'стоматолог-ортопед.JPG',
          route: 'StomatologOrtoped'
        },
        // Гастроэнтеролог — временно отключено (услуга может возобновиться)
        // {
        ...
        // {
        //   name: 'Нейрохирург', 
        //   desc: 'Эта область медицины охватывает широкий спектр проблем, включая заболевания головного и спинного мозга, нервы и сосуды, питающие эти структуры.', 
        //   src: 'Нейрохирург.jpeg',
        //   route: 'Neirohirurg',
        //   buttonVisible: true
        // },
        // {
        //   name: 'Сердечно-сосудистый хирург', 
        //   desc: 'Эта область медицины охватывает широкий спектр заболеваний, включая коронарные болезни, пороки сердца, аневризмы сосудов и другие сердечно-сосудистые расстройства.', 
        //   src: 'Сердечно-сосудистый хирург.jpeg',
        //   route: 'Sshirurg',
        //   buttonVisible: true
        // },
        {
        ...
        // Невролог — временно отключено (услуга может возобновиться)
        // {
        //   name: 'Невролог', 
        ...
        // Офтальмолог — временно отключено (услуга может возобновиться)
        // {
        //   name: 'Офтальмолог', 
        ...
        // Уролог — временно отключено (услуга может возобновиться)
        // {
        //   name: 'Уролог', 
        ...
        },
        {
          ...
          desc: 'Консультация специалиста перед медицинским прерыванием беременности: конфиденциальная беседа, информация для осознанного решения и сопровождение в соответствии с порядком оказания помощи.',
          src: 'Доабортное-консультирование.jpg',
