    ...
    data() {
        return {
            ...
            lor_procedures: [
                ...
                {
                    name: 'Лечение синусита (гайморита, фронтита) методом «перемещения» (1 сеанс). В процедуру входит 1 фл. (200 мл) физ. р-ра + 1 амп. диоксидина',
                    price: '700 руб',
                },
                {
                ...
                {
                    name: 'Удаление инородного тела из глотки',
                    price: '800 руб',
                },
                {
                ...
                {
                    name: 'Удаление базалиомы, атеромы лица, уха (доброкачественного новообразования)',
                    price: '2 500 руб',
                },
                {
