...
export default {
    ...
    data() {
        return {
            mammolog_services: [
                {
                    name: 'Прием (осмотр, консультация) врача онколога-маммолога первичный',
                    price: '3 300 руб (50%/50%)'
                },
                {
                    name: 'Прием (осмотр, консультация) врача онколога-маммолога повторный',
                    price: '3 100 руб (50%/50%)'
                },
                {
                    name: 'Пункция новообразования молочной железы прицельная пункционная (без контроля ультразвукового исследования) без стоимости анализа',
                    price: '3 200 руб'
                },
                {
                    name: 'Пункция новообразования молочной железы прицельная пункционная под контролем ультразвукового исследования без стоимости анализа',
                    price: '3 700 руб'
                },
                {
