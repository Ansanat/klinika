    ...
    data() {
        return {
            ginecolog_services: [
                ...
                {
                    name: 'Консультация по беременности с осмотром для фарм. аборта (в том числе анализы)',
                    price: '4 000 руб'
                },
                {
                    name: 'Медикаментозный аборт до 6 нед (без стоимости приема). Один прием после процедуры входит в стоимость',
                    price: '15 000 руб'
                },
                {
